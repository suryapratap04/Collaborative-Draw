    ...
    <div className="py-12 bg-white dark:bg-zinc-900" id="features">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <h2 className="text-base text-yellow-600 dark:text-yellow-400 font-semibold tracking-wide uppercase">
            Features
          </h2>
          ...
          <p className="mt-4 max-w-2xl text-xl text-zinc-500 dark:text-zinc-400 lg:mx-auto">
            CoDraw provides all the tools you need for effective visual
            collaboration.
          </p>
        </div>
