...
export default function HowItWorks() {
  return (
    <div
      className="py-16 bg-white dark:bg-zinc-900 overflow-hidden lg:py-24"
      id="how-it-works"
    >
      <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
        <div className="relative">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-center text-xl text-zinc-500 dark:text-zinc-400">
            Get started with CoDraw in just a few simple steps.
          </p>
        </div>
        ...
        <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
          <div className="relative">
            ...
            <p className="mt-3 text-lg text-zinc-500">
              CoDraw is designed to be intuitive and easy to use. Follow these
              simple steps to get started with your team.
            </p>
                ...
                return (
                  <div key={step.name} className="relative">
                    <dt>
                      ...
                      <p className="ml-16 text-lg leading-6 font-medium text-zinc-900 dark:text-zinc-100">
                        {step.name}
                      </p>
                    </dt>
